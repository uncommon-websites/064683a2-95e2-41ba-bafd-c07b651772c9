     ...
     <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid md:grid-cols-2 border border-gray-200">
             ...
             <div class="relative h-[600px] bg-gray-100 overflow-hidden group">
                 <img src="/generated/image-confident-male-trader-in-his-40s-profess-1765727325422-1.webp" alt="Ameet Rai" class="absolute inset-0 w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-500" />
