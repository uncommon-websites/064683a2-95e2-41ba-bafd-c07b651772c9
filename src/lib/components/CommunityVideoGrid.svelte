    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="mt-12 flex flex-col md:flex-row items-center gap-8 max-w-5xl mx-auto">
            ...
            <div class="flex-1 text-center md:text-left">
                <blockquote class="text-2xl md:text-3xl font-serif-display text-amber-600 leading-tight">
                    "TraderLion's systematic approach transformed my trading. Finally, education that actually works!"
                </blockquote>
                <div class="mt-4 text-xs font-bold uppercase tracking-widest text-gray-400">
                    Michael Chen <br/>
                    <span class="text-gray-300">Active Trader, TraderLion Member</span>
                </div>
            </div>
        </div>
    </div>
